...
from azservices import create_queue_service, create_table_service
...
def main():
    ...
    qsvc = create_queue_service(storage_client, RG_NAME, SA_NAME)
    ...
    if ROLE == MGR_ROLE:
        ...
        if HAS_DDC:
            ...
            tbl_svc_dtr = create_table_service(storage_account, RG_NAME, dtr_sa_name)
